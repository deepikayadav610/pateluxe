      ...
      <div className="pearl-hero-split">
        <div className="pearl-hero-left">
          ...
          <p className="pearl-hero-subtext">
            ...
            wisdom, and quiet elegance. At Pateluxe, we curate exquisite pearls
            that reflect our dedication to classic jewels and modern luxury.
            Astrologically, pearl is believed to promote emotional balance
            (भावनात्मक संतुलन), inner peace (आंतरिक शांति), and calmness
            (शांतता), and is associated with the Moon.
          </p>
        </div>
