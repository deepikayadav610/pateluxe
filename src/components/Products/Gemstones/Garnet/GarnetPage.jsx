      ...
      <div className="garnet-hero-split">
        <div className="garnet-hero-left">
          ...
          <p className="garnet-hero-subtext">
            ...
            jewels and modern luxury. Astrologically, Garnet/Gomad is associated
            with Rahu and is believed to enhance courage (साहस), clarity
            (स्पष्टता), and confidence (आत्मविश्वास).
          </p>
        </div>
