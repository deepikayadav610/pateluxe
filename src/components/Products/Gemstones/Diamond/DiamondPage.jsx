        ...
        <div className="diamond-hero-split">
          <div className="diamond-hero-left">
            ...
            <p className="diamond-hero-subtext">
              Diamond has long been revered as a symbol of strength, clarity,
              and timeless beauty. At Pateluxe, we curate premium diamonds that
              reflect our commitment to classic jewels and modern luxury.
              Astrologically, diamond is associated with the Venus and is
              believed to enhance harmony (संतुलन), love (प्रेम), beauty
              (सौंदर्य), and material comfort (सामग्री सुख).
            </p>
          </div>
