    ...
    <section className="gemstone-section">
      <div className="container text-center">
        ...
        <p className="section-subtitle">
          Discover rare gemstones crafted to perfection. Every piece reflects
          elegance, luxury, and natural brilliance, curated exclusively for
          those who value sophistication.
        </p>
